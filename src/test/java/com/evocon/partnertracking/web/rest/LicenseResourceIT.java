...
class LicenseResourceIT {
    ...
    public static License createEntity() {
        return new License()
            ...
            .commissionRuleSetId(DEFAULT_COMMISSION_RULE_SET_ID)
    ...
    public static License createUpdatedEntity() {
        return new License()
            ...
            .commissionRuleSetId(UPDATED_COMMISSION_RULE_SET_ID)
    ...
    void checkCommissionRuleSetIdIsRequired() throws Exception {
        long databaseSizeBeforeTest = getRepositoryCount();
        // set the field null
        license.setCommissionRuleSetId(null);
