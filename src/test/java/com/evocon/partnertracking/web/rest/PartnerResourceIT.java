...
class PartnerResourceIT {
    ...
    public static Partner createEntity() {
        return new Partner().partnerName(DEFAULT_PARTNER_NAME);
    }
    ...
    public static Partner createUpdatedEntity() {
        return new Partner().partnerName(UPDATED_PARTNER_NAME);
    }
    ...
    void putExistingPartner() throws Exception {
        ...
        updatedPartner.partnerName(UPDATED_PARTNER_NAME);
    ...
    void fullUpdatePartnerWithPatch() throws Exception {
        ...
        partialUpdatedPartner.partnerName(UPDATED_PARTNER_NAME);
