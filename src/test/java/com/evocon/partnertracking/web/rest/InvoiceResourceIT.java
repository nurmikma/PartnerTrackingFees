...
import static com.evocon.partnertracking.domain.InvoiceAsserts.*;
...
class InvoiceResourceIT {
    ...
    void partialUpdateInvoiceWithPatch() throws Exception {
        ...
        partialUpdatedInvoice.clientId(UPDATED_CLIENT_ID).invoiceAmount(UPDATED_INVOICE_AMOUNT).invoiceType(UPDATED_INVOICE_TYPE);
