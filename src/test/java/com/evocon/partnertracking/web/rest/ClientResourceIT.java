...
class ClientResourceIT {
    ...
    public static Client createEntity() {
        return new Client().clientName(DEFAULT_CLIENT_NAME);
    }
    ...
    public static Client createUpdatedEntity() {
        return new Client().clientName(UPDATED_CLIENT_NAME);
    }
    ...
    void putExistingClient() throws Exception {
        ...
        updatedClient.clientName(UPDATED_CLIENT_NAME);
    ...
    void fullUpdateClientWithPatch() throws Exception {
        ...
        partialUpdatedClient.clientName(UPDATED_CLIENT_NAME);
