...
class CommissionRuleSetResourceIT {
    ...
    private static final String DEFAULT_COMMISSION_RULE_SET_ID = "AAAAAAAAAA";
    private static final String UPDATED_COMMISSION_RULE_SET_ID = "BBBBBBBBBB";
    ...
    public static CommissionRuleSet createEntity() {
        return new CommissionRuleSet().commissionRuleSetId(DEFAULT_COMMISSION_RULE_SET_ID).ruleSetName(DEFAULT_RULE_SET_NAME);
    }
    ...
    public static CommissionRuleSet createUpdatedEntity() {
        return new CommissionRuleSet().commissionRuleSetId(UPDATED_COMMISSION_RULE_SET_ID).ruleSetName(UPDATED_RULE_SET_NAME);
    }
    ...
    @Test
    @Transactional
    void checkCommissionRuleSetIdIsRequired() throws Exception {
        long databaseSizeBeforeTest = getRepositoryCount();
        // set the field null
        commissionRuleSet.setCommissionRuleSetId(null);
    ...
    void getAllCommissionRuleSets() throws Exception {
        ...
        restCommissionRuleSetMockMvc
            ...
            .andExpect(jsonPath("$.[*].commissionRuleSetId").value(hasItem(DEFAULT_COMMISSION_RULE_SET_ID)))
    ...
    void getCommissionRuleSet() throws Exception {
        ...
        restCommissionRuleSetMockMvc
            ...
            .andExpect(jsonPath("$.commissionRuleSetId").value(DEFAULT_COMMISSION_RULE_SET_ID))
    ...
    void putExistingCommissionRuleSet() throws Exception {
        ...
        updatedCommissionRuleSet.commissionRuleSetId(UPDATED_COMMISSION_RULE_SET_ID).ruleSetName(UPDATED_RULE_SET_NAME);
    ...
    void fullUpdateCommissionRuleSetWithPatch() throws Exception {
        ...
        partialUpdatedCommissionRuleSet.commissionRuleSetId(UPDATED_COMMISSION_RULE_SET_ID).ruleSetName(UPDATED_RULE_SET_NAME);
