      ...
      <table class="table table-striped" aria-describedby="licenses">
        <thead>
          <tr>
            ...
            <th scope="row" @click="changeOrder('licenseId')">
              <span v-text="t$('partnerTrackingFeesApp.license.licenseId')"></span>
              <jhi-sort-indicator :current-order="propOrder" :reverse="reverse" :field-name="'licenseId'"></jhi-sort-indicator>
            </th>
        ...
        <tbody>
          <tr v-for="license in licenses" :key="license.id" data-cy="entityTable">
            ...
            <td>{{ license.partnerId }}</td>
            <td>{{ license.commissionRuleSetId }}</td>
