      ...
      <form name="editForm" novalidate @submit.prevent="save()">
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('partnerTrackingFeesApp.license.licenseId')" for="license-licenseId"></label>
            <input
              type="text"
              class="form-control"
              name="licenseId"
              ...
              data-cy="licenseId"
              :class="{ valid: !v$.licenseId.$invalid, invalid: v$.licenseId.$invalid }"
              v-model="v$.licenseId.$model"
              required
            />
            <div v-if="v$.licenseId.$anyDirty && v$.licenseId.$invalid">
              <small class="form-text text-danger" v-for="error of v$.licenseId.$errors" :key="error.$uid">{{ error.$message }}</small>
            </div>
          </div>
          <div class="form-group">
            <label
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('partnerTrackingFeesApp.license.clientId')" for="license-clientId"></label>
            <input
              type="text"
              class="form-control"
              name="clientId"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('partnerTrackingFeesApp.license.partnerId')" for="license-partnerId"></label>
            <input
              type="text"
              class="form-control"
              name="partnerId"
              id="license-partnerId"
              data-cy="partnerId"
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="t$('partnerTrackingFeesApp.license.commissionRuleSetId')"
              for="license-commissionRuleSetId"
            ></label>
            <input
              type="text"
              class="form-control"
              name="commissionRuleSetId"
              id="license-commissionRuleSetId"
              data-cy="commissionRuleSetId"
              :class="{ valid: !v$.commissionRuleSetId.$invalid, invalid: v$.commissionRuleSetId.$invalid }"
              v-model="v$.commissionRuleSetId.$model"
              required
            />
            <div v-if="v$.commissionRuleSetId.$anyDirty && v$.commissionRuleSetId.$invalid">
              <small class="form-text text-danger" v-for="error of v$.commissionRuleSetId.$errors" :key="error.$uid">{{
                error.$message
              }}</small>
            </div>
          </div>
