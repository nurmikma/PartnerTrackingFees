...
describe('Service Tests', () => {
  describe('License Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new License(123, 'AAAAAAA', 'AAAAAAA', currentDate, currentDate, 0, 0, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 0);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should partial update a License', async () => {
        const patchObject = { licenseRuleName: 'BBBBBB', clientId: 'BBBBBB', commissionRuleSetId: 'BBBBBB', ...new License() };
