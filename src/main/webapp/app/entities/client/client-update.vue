      ...
      <form name="editForm" novalidate @submit.prevent="save()">
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('partnerTrackingFeesApp.client.clientId')" for="client-clientId"></label>
            <input
              type="text"
              class="form-control"
              name="clientId"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('partnerTrackingFeesApp.client.partnerId')" for="client-partnerId"></label>
            <input
              type="text"
              class="form-control"
              name="partnerId"
